...
catch(e){$('#error').style.display='block';$('#error').textContent='이 페인트된 세계는 WebGL이 필요합니다. 그래픽 가속을 켜고 새로고침해 주세요.';throw e;}
...
renderer.domElement.id='world';renderer.domElement.tabIndex=0;renderer.domElement.setAttribute('aria-label','고흐 스트라이크 게임 월드. 클릭해 마우스를 잡으세요.');
